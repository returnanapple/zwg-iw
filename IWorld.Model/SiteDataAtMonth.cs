...
namespace IWorld.Model
{
    ...
    /// 站点统计信息（月）
    /// </summary>
    public class SiteDataAtMonth : ModelBase
    {
        #region 公开属性
        ...
        public SiteDataAtMonth(DateTime now)
        {
            this.Year = now.Year;
            this.Month = now.Month;
            List<string> ignore = new List<string> { "Id", "CreatedTime", "ModifiedTime", "Year", "Month" };
            typeof(SiteDataAtMonth).GetProperties().ToList()
                .ForEach(x =>
                {
