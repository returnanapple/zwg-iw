...
namespace IWorld.Model
{
    ...
    /// 个人信息统计（日）
    /// </summary>
    public class PersonalDataAtDay : ModelBase
    {
        #region 公开属性
        ...
        public PersonalDataAtDay(Author owner)
        {
            ...
            List<string> ignore = new List<string> { "Id", "CreatedTime", "ModifiedTime", "Year", "Month", "Day", "Owner", "Money" };
            typeof(PersonalDataAtDay).GetProperties().ToList()
                .ForEach(x =>
                {
